...
class DispatchError extends Base
{
    ...
    public function latch(MvcEvent $e)
    {
        ...
        $this->latchTo(MvcEvent::EVENT_DISPATCH_ERROR, function (MvcEvent $e) use ($debug, $intercept, $apiRequestDetector) {
            if ($apiRequestDetector->isApiRequest($e) && $intercept) {
        ...
        $this->latchTo( MvcEvent::EVENT_DISPATCH_ERROR, function (MvcEvent $e) use ($debug, $apiRequestDetector) {
